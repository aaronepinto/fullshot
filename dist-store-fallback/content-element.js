...
(() => {
  ...
  (() => {
    ...
    root.innerHTML = `
    <style>
      /* Matches the region overlay's chrome exactly: same ink pill, same single
         sky accent, same system font, for the same reason. */
      .hint {
      ...
      .chip {
        position: fixed; display: none; background: #38bdf8; color: #0a0a0c;
